...
# module references:
# ikun_multi_frame_top, helai_hdmi_out
...
proc create_hier_cell_reset { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk ui_clk_div
  create_bd_pin -dir O -from 0 -to 0 -type rst ui_div_rstn
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins slowest_sync_clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins dcm_locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked] [get_bd_pins rst_clk_wiz_1_100M1/dcm_locked]
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_pins ui_clk_div] [get_bd_pins rst_clk_wiz_1_100M1/slowest_sync_clk]
  connect_bd_net -net mig_7series_0_ui_clk_sync_rst [get_bd_pins ext_reset_in] [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in] [get_bd_pins rst_clk_wiz_1_100M1/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_1_100M1_peripheral_aresetn [get_bd_pins ui_div_rstn] [get_bd_pins rst_clk_wiz_1_100M1/peripheral_aresetn]
...
proc create_hier_cell_VIDEO_OUT { parentCell nameHier } {
  ...
  create_bd_pin -dir I hdmi_clkx5
  create_bd_pin -dir I -type rst hdmi_rstn
  create_bd_pin -dir O -type clk o_hdmi_clk_n
  create_bd_pin -dir O -type clk o_hdmi_clk_p
  create_bd_pin -dir O -from 2 -to 0 o_hdmi_data_n
  create_bd_pin -dir O -from 2 -to 0 o_hdmi_data_p

  # Create instance: helai_hdmi_out_0, and set properties
  set block_name helai_hdmi_out
  set block_cell_name helai_hdmi_out_0
  if { [catch {set helai_hdmi_out_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $helai_hdmi_out_0 eq "" } {
  ...
  # Create port connections
  connect_bd_net -net clk_0_1 [get_bd_pins hdmi_clk] [get_bd_pins helai_hdmi_out_0/clk_hdmi] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  connect_bd_net -net clk_hdmix5_0_1 [get_bd_pins hdmi_clkx5] [get_bd_pins helai_hdmi_out_0/clk_hdmix5]
  connect_bd_net -net helai_hdmi_out_0_o_hdmi_clk_n [get_bd_pins o_hdmi_clk_n] [get_bd_pins helai_hdmi_out_0/o_hdmi_clk_n]
  connect_bd_net -net helai_hdmi_out_0_o_hdmi_clk_p [get_bd_pins o_hdmi_clk_p] [get_bd_pins helai_hdmi_out_0/o_hdmi_clk_p]
  connect_bd_net -net helai_hdmi_out_0_o_hdmi_data_n [get_bd_pins o_hdmi_data_n] [get_bd_pins helai_hdmi_out_0/o_hdmi_data_n]
  connect_bd_net -net helai_hdmi_out_0_o_hdmi_data_p [get_bd_pins o_hdmi_data_p] [get_bd_pins helai_hdmi_out_0/o_hdmi_data_p]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins aclk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  connect_bd_net -net resetn_0_1 [get_bd_pins hdmi_rstn] [get_bd_pins helai_hdmi_out_0/reset_n] [get_bd_pins v_tc_0/resetn]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins helai_hdmi_out_0/i_vga_de] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins helai_hdmi_out_0/i_vga_rgb] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins helai_hdmi_out_0/i_vga_hs] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins helai_hdmi_out_0/i_vga_vs] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
...
proc create_root_design { parentCell } {
  ...
  set ddr3_ok [ create_bd_port -dir O ddr3_ok ]
  set hdmi_clk [ create_bd_port -dir I -type clk -freq_hz 74250000 hdmi_clk ]
  set hdmi_clkx5 [ create_bd_port -dir I hdmi_clkx5 ]
  set hdmi_rstn [ create_bd_port -dir I -type rst hdmi_rstn ]
  set o_hdmi_clk_n [ create_bd_port -dir O -type clk o_hdmi_clk_n ]
  set o_hdmi_clk_p [ create_bd_port -dir O -type clk o_hdmi_clk_p ]
  set o_hdmi_data_n [ create_bd_port -dir O -from 2 -to 0 o_hdmi_data_n ]
  set o_hdmi_data_p [ create_bd_port -dir O -from 2 -to 0 o_hdmi_data_p ]
  set ui_clk_div [ create_bd_port -dir O -type clk ui_clk_div ]
  set ui_div_rstn [ create_bd_port -dir O -from 0 -to 0 -type rst ui_div_rstn ]
  set vid_ce [ create_bd_port -dir I -type ce vid_ce ]
  set vid_data [ create_bd_port -dir I -from 23 -to 0 vid_data ]
  set vid_de [ create_bd_port -dir I vid_de ]
  set vid_pclk [ create_bd_port -dir I -type clk -freq_hz 74250000 vid_pclk ]
  ...
  # Create instance: ikun_multi_frame_top_0, and set properties
  set block_name ikun_multi_frame_top
  set block_cell_name ikun_multi_frame_top_0
  if { [catch {set ikun_multi_frame_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ikun_multi_frame_top_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROBE_OUT0_INIT_VAL {0x4b} \
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins ikun_multi_frame_top_0/s1_axis]
  ...
  connect_bd_intf_net -intf_net axi_vdma_1_M_AXIS_MM2S [get_bd_intf_pins VIDEO_OUT/video_in] [get_bd_intf_pins axi_vdma_1/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins ikun_multi_frame_top_0/s0_axis]
  ...
  connect_bd_intf_net -intf_net ikun_multi_frame_top_0_m_axis [get_bd_intf_pins axi_vdma_1/S_AXIS_S2MM] [get_bd_intf_pins ikun_multi_frame_top_0/m_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets v_vid_in_axi4s_0_video_out] [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets v_vid_in_axi4s_0_video_out]

  # Create port connections
  connect_bd_net -net clk_0_1 [get_bd_ports hdmi_clk] [get_bd_pins VIDEO_OUT/hdmi_clk]
  connect_bd_net -net clk_hdmix5_0_1 [get_bd_ports hdmi_clkx5] [get_bd_pins VIDEO_OUT/hdmi_clkx5]
  ...
  connect_bd_net -net helai_hdmi_out_0_o_hdmi_clk_n [get_bd_ports o_hdmi_clk_n] [get_bd_pins VIDEO_OUT/o_hdmi_clk_n]
  connect_bd_net -net helai_hdmi_out_0_o_hdmi_clk_p [get_bd_ports o_hdmi_clk_p] [get_bd_pins VIDEO_OUT/o_hdmi_clk_p]
  connect_bd_net -net helai_hdmi_out_0_o_hdmi_data_n [get_bd_ports o_hdmi_data_n] [get_bd_pins VIDEO_OUT/o_hdmi_data_n]
  connect_bd_net -net helai_hdmi_out_0_o_hdmi_data_p [get_bd_ports o_hdmi_data_p] [get_bd_pins VIDEO_OUT/o_hdmi_data_p]
  connect_bd_net -net ikun_multi_frame_top_0_target_num_out [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins ikun_multi_frame_top_0/target_num_out]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins reset/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins VIDEO_OUT/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/M03_ACLK] [get_bd_pins axi_interconnect_1/M04_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins ikun_multi_frame_top_0/clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins reset/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins vio_0/clk]
  connect_bd_net -net mig_7series_0_init_calib_complete [get_bd_ports ddr3_ok] [get_bd_pins mig_7series_0/init_calib_complete]
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins mig_7series_0/mmcm_locked] [get_bd_pins reset/dcm_locked]
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_ports ui_clk_div] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins reset/ui_clk_div]
  connect_bd_net -net mig_7series_0_ui_clk_sync_rst [get_bd_pins mig_7series_0/ui_clk_sync_rst] [get_bd_pins reset/ext_reset_in]
  connect_bd_net -net resetn_0_1 [get_bd_ports hdmi_rstn] [get_bd_pins VIDEO_OUT/hdmi_rstn]
  connect_bd_net -net rst_clk_wiz_1_100M1_peripheral_aresetn [get_bd_ports ui_div_rstn] [get_bd_pins reset/ui_div_rstn]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins reset/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins reset/mb_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/M03_ARESETN] [get_bd_pins axi_interconnect_1/M04_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins ikun_multi_frame_top_0/rst_n] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins reset/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net vid_active_video_0_1 [get_bd_ports vid_de] [get_bd_pins ila_0/probe0] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets vid_active_video_0_1]
  connect_bd_net -net vid_data_0_1 [get_bd_ports vid_data] [get_bd_pins ila_0/probe2] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets vid_data_0_1]
  connect_bd_net -net vid_io_in_ce_0_1 [get_bd_ports vid_ce] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net vid_io_in_clk_0_1 [get_bd_ports vid_pclk] [get_bd_pins ila_0/clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net vid_vsync_0_1 [get_bd_ports vid_vs] [get_bd_pins ila_0/probe1] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets vid_vsync_0_1]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins ikun_multi_frame_top_0/Diff_Threshold] [get_bd_pins vio_0/probe_out0]
  ...
  assign_bd_address -offset 0x80000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces axi_vdma_1/Data_MM2S] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
